...
IF("${LN_ARCH}" STREQUAL "RISCV") # RISCV
  IF( ${LN_MCU} STREQUAL "CH32V3x")    #----------CH32V307
    ...
    ELSE(WIN32)      
      #--- GCC ---------
      SET(PLATFORM_TOOLCHAIN_PATH "/riscv/tools8/bin" CACHE INTERNAL "")    
      IF(USE_HW_FPU)
        SET(PLATFORM_C_FLAGS "-march=rv32imafc_zicsr -mabi=ilp32f " CACHE INTERNAL "")
      ELSE()
        SET(PLATFORM_C_FLAGS "-march=rv32imac_zicsr -mabi=ilp32 " CACHE INTERNAL "")
      ENDIF()
