...
#define LIST_OF_INTERRUPTS                                                                                             \
    INTERRUPT_DESC(unsupported),                                  /* 0 .word   RESET                        */         \
        INTERRUPT_DESC(unsupported),                              /* 1 .word   0                            */         \
        INTERRUPT_DESC(unsupported),                              /* 2 .word   NMI_Handler                  */         \
        INTERRUPT_DESC(unsupported),                              /* 3 .word   HardFault_Handler            */         \
        INTERRUPT_DESC(unsupported),                              /* 4 .word   0                            */         \
        INTERRUPT_DESC(unsupported),                              /* 5 .word   Ecall_M_Mode_Handler         */         \
        INTERRUPT_DESC(unsupported),                              /* 6 .word   0                            */         \
        INTERRUPT_DESC(unsupported),                              /* 7 .word   0                            */         \
        INTERRUPT_DESC(unsupported),                              /* 8 .word   Ecall_U_Mode_Handler         */         \
        INTERRUPT_DESC(unsupported), INTERRUPT_DESC(unsupported), /* 10 .word   0                           */         \
        ...
        INTERRUPT_DESC(unsupported), INTERRUPT_DESC(unsupported), INTERRUPT_DESC(unsupported),                         \
        INTERRUPT_DESC(unsupported), INTERRUPT_DESC(unsupported), INTERRUPT_DESC(unsupported),                         \
        INTERRUPT_DESC(unsupported), INTERRUPT_DESC(unsupported), /*.word   ADC1_2_IRQHandler               */         \
        ...
        INTERRUPT_DESC(unsupported), INTERRUPT_DESC(unsupported), INTERRUPT_DESC(unsupported),                         \
        INTERRUPT_DESC(unsupported), INTERRUPT_DESC(unsupported), /*.word   SPI1_IRQHandler             */             \
        ...
        INTERRUPT_DESC(unsupported), INTERRUPT_DESC(unsupported), INTERRUPT_DESC(unsupported),                         \
        INTERRUPT_DESC(unsupported), INTERRUPT_DESC(unsupported),                                                      \
        ...
        INTERRUPT_DESC(unsupported), INTERRUPT_DESC(unsupported), /*.word   DVP_IRQHandler              */             \
